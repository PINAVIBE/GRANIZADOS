/* =========================================================
   ...
   Fase 1: todo vive "en memoria" (en variables de JS).
   Si recargás la página, el pedido se borra.
   Eso es justo lo que resolveremos en la Fase 3 con un backend.
   ========================================================= */
...
// 9) CONFIRMAR PEDIDO
// Por ahora solo genera un número de orden local.
// En la Fase 3, aquí es donde enviaríamos el pedido a la base de datos.
